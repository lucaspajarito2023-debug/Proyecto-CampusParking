...
function showEditProfile(){
    ...
    <input id="newName" value="${admin.name}">
    <input id="newEmail" value="${admin.email}">
    <input id="newUser" value="${admin.user}">
    <input id="newPassword" value="${admin.password}">
...
function searchVehicle(){
    ...
    <div class="dashboard-box">
        ...
        <p>Slot: ${vehicle.slot}</p>
        <button onclick="finishService('${vehicle.plate}')">
            Finalizar
        </button>
